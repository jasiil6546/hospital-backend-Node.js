...
app.post('/booking', (req, res) => {
    const { Name, Age, phone, Email, Gender, Address, doctors } = req.body;
    const Token = generateToken('');
    console.log(Name, Age, phone, Email, Gender, Address, doctors, Token);


    connection.query('INSERT INTO patients(Name, Age, phone, Email, Gender, Address, doctors,Token) VALUES (?,?,?,?,?,?,?,?)', [Name, Age, phone, Email, Gender, Address, doctors, Token], (error, results) => {
        if (error) {
