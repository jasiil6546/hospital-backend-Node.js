...
app.post('/booking', (req, res) => {
    const { Name, Age, phone, Email, Gender, Address, location } = req.body;
    console.log(name, age, location);


    connection.query('INSERT INTO patients(name,age,location) VALUES (?,?,?)', [name, age, location], (error, results) => {
        if (error) {
