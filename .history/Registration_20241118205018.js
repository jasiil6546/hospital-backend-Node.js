...
app.post('/booking', (req, res) => {
    ...
    connection.query('INSERT INTO patients(Name, Age, hone, Email, Gender, Address, doctors, Token) VALUES (?,?,?,?,?,?,?,?)', [Name, Age, Phone, Email, Gender, Address, doctors, Token], (error, results) => {
        if (error) {
