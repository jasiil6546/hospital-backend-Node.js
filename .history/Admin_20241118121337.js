...
router.post('/insert', async(req, res) => {
    ...
    try {
        ...
        connection.query(`INSERT INTO ? (User_Name, Name, Age, phone, Email, Gender, Duty_time) VALUES (?, ?, ?, ?, ?, ?, ?, ?)`, [table, Id, User_Name, Name, Age, phone, Email, Gender, Duty_time], (error, result) => {
            if (error) {
