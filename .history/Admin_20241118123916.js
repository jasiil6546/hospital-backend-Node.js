...
router.post('/insert', (req, res) => {
    ...
    try {
        ...
        connection.query(`INSERT INTO ${table} (User_Name, Name, Age, phone, Email, Gender,C Duty_time) VALUES( ? , ? , ? , ? , ? , ? , ? )`, [table, User_Name, Name, Age, phone, Email, Gender, Duty_time], (error, result) => {
            if (error) {
