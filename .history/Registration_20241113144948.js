...
app.post('/insert', (req, res) => {
    ...
    connection.query registrations('INSERT INTO registrations(User_Name,Name,Age,phone,Email,Gender,Category,Departement) VALUES (?,?,?,?,?,?,?,?)', [name, age, phone], (error, results) => {
        if (error) {
