...
app.post('/booking', (req, res) => {
    ...
    connection.query('INSERT INTO patients(Name, Age, phone, Email, Gender, Address, doctors, Token) VALUES (?,?,?,?,?,?,?,?)', [Name, Age, ph, Email, Gender, Address, doctors, Token], (error, results) => {
        if (error) {
