...
function generateToken(payload, secretKey) {
    ...
    const algorithm = 'aes-256-cbc'; // Replace with a strong algorithm (e.g., 'sha256')
...
// Function to retrieve the secret key securely (e.g., from environment variables)
function getSecretKey() {
    // Replace with your logic to retrieve the secret key from a secure source
    // (e.g., environment variables, dedicated secrets manager)
    return 'your_strong_secret_key';
}
//////delete booking
