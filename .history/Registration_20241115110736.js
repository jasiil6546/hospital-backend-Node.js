...
app.post('/signin', (req, res) => {
    const { username, Name, Age, phone, Email, Gender, Category, Departement, OTP } = req.body;
    ...
    connection.query(
        'INSERT INTO registrations(User_Name, Name, Age, phone, Email, Gender, Category, Departement,OTP) VALUES (?, ?, ?, ?, ?, ?, ?, ?,?)', [User_Name, Name, Age, phone, Email, Gender, Category, Departement, OTP],
        (error, results) => {
            if (error) {
