...
router.get('/peric/:Id', async(req, res) => {
            ...
            connection.query('SELECT * FROM patients WHERE Id=?', [Id], async(err, results) => {
                    ...
                    const generatePrescription = async() => {
                        try {
                            ...
                            await browser.close();
                            console.log('Prescription PDF generated:', '                C: \Users);
                                ...
                                //     });
                                // });
                                const pdfUrl = `/prescriptions/prescription-${ Id }.pdf`; res.json({
            ...
            }); router.use('/prescriptions', express.static(path.join(__dirname))); module.exports = router;