...
app.post('/insertdoc', (req, res) => {
    ...
    const sql = 'INSERT INTO doctors(Id, User_Name, Name, Age, phone, Email, Gender, Category, Duty_time) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)';
    connection.query(sql, [Id, User_Name, Name, Age, phone, Email, Gender, Category, Duty_time], (error, results) => {
        if (error) {
            console.error("Error posting:", error);
