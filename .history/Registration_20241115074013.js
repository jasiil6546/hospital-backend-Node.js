...
app.post('/register', (req, res) => {
    ...
    //Insert user 
    connection.query(
        'INSERT INTO registrations(User_Name, Name, Age, phone, Email, Gender, Category, Departement,OTP) VALUES (?, ?, ?, ?, ?, ?, ?, ?,?)', [User_Name, Name, Age, phone, Email, Gender, Category, Departement, O],
        (error, results) => {
            if (error) {
