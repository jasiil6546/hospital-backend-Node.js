...
app.post('/register', (req, res) => {
    ...
    //Insert user 
    connection.query(
        'INSERT INTO registrations(User_Name, Name, Age, phone, Email, Gender, Category, Departement,OTP) VALUES (?, ?, ?, ?, ?, ?, ?, ?,)', [User_Name, Name, Age, phone, Email, Gender, Category, Departement],
        (error, results) => {
            if (error) {
