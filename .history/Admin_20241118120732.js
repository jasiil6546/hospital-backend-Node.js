...
router.post('/insert', async(req, res) => {
    ...
    try {
        ...
        connection.query(`INSERT INTO ? (Id, User_Name, Name, Age, phone, Email, Gender, Duty_time) VALUES (?, ?, ?, ?, ?, ?, ?, ?)`, [Id, User_Name, Name, Age, phone, Email, Gender, Duty_time], (error, result) => {
            if (error) {
