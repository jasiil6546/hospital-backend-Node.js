...
router.post('/insert', async(req, res) => {
            ...
            try {
                ...
                connection.query(`INSERT INTO ${table} (Id, User_Name, Name, Age, phone, Email, Gender, Duty_time) VALUES (?, ?, ?, ?, ?, ?, ?, ?)`, [Id, User_Name, Name, Age, phone, Email, Gender, Duty_time], (error, results) => {
