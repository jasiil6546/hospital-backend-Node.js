...
app.post('/insertdoc', (req, res) => {
    ...
    connection.query('INSERT INTO doctors and patients(Id,User_Name, Name, Age, phone, Email, Gender, Category, Duty_time) VALUES (?,?,?,?,?,?,?,?)', [Id, User_Name, Name, Age, phone, Email, Gender, Category, Duty_time], (error, results) => {
        if (error) {
