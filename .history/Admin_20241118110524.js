...
router.post('/insert', async(req, res) => {
    ...
    try {
        ...
        connection.query(`INSERT INTO registrations (Id, User_Name, Name, Age, phone, Email, Gender, Category, Duty_time, ${table}_Category)
        SELECT ?, ?, ?, ?, ?, ?, ?, ?, ?, 
        FROM ${tableToJoin}
        WHERE ${tableToJoin}.Category = ?`, [Id, User_Name, Name, Age, phone, Email, Gender, Category, Duty_time, Id]);
